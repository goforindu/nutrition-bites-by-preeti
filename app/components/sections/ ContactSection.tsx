...
export function ContactSection() {
  ...
  return (
    ...
    >
      {/* decorative background glows */}
      <div className="pointer-events-none absolute -top-20 left-0 w-80 h-80 bg-green-300/20 blur-3xl rounded-full" />
      <div className="pointer-events-none absolute -bottom-20 right-0 w-80 h-80 bg-green-300/20 blur-3xl rounded-full" />
      ...
      <div className="max-w-6xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-10 items-start relative z-10">
        ...
        <div>
          ...
          <div className="mt-8 space-y-4 text-sm">
            <div className="flex items-center gap-3 group">
              ...
              <a
                href="tel:+919625310091"
                className="underline decoration-green-400 group-hover:text-green-700 transition font-medium"
              >
                +91 96253 10091
              </a>
            </div>
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="relative rounded-xl bg-gradient-to-r from-green-700 to-green-600 
              text-white px-4 py-3 font-semibold shadow-lg hover:shadow-xl 
              hover:scale-[1.02] transition-transform disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {loading ? "Sending..." : "Send Request"}
            <span className="pointer-events-none absolute inset-0 rounded-xl ring-2 ring-green-600/20 animate-pulse"></span>
          </button>
