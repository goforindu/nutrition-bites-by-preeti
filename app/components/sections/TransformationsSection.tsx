...
const TransformationsSection = () => {
  const transformations = [
    ...
    },
    {
      ...
      highlight:
        "30-year-old AIIMS nurse & new mom Anju transformed herself post-pregnancy — from 91 kg to 77 kg, better energy, leg pain gone and cravings managed — all while balancing newborn care and hospital duties. Truly inspiring!",
    },
  ];
    ...
    >
      ...
      <div className="relative z-10">
            ...
            >
              ...
              <div className="p-4 flex-1 flex flex-col">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="text-[11px] text-slate-500 bg-green-50 border border-green-100 rounded-full px-2 py-0.5">
                    {t.duration}
                  </div>
                </div>
        ...
        <div className="mt-10 text-center">
          <a
            href="#contact"
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-green-700 to-green-600 text-white px-5 py-2.5 text-sm font-semibold shadow-lg hover:bg-green-800 hover:scale-105 transition"
          >
